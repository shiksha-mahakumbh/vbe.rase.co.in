...
const About = () => {
  ...
  const publisherInfo = (
    <div className="mt-6">
      ...
      <p className="text-black">Published by: Dr. Thakur Sudesh Kumar Raunija</p>
